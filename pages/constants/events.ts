...
const GAMES_RULES: Record<EGameTypes, RulesPageData> = {
  [EGameTypes.MAFIA]: {
    icon: MafiaLogo,
    title: 'Мафия',
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          '<b>Мафия=(Общее число игроков/4).</b>',
      ...
      {
        title: 'Второй и последующие дни',
        content: [
...
const GAMES_OPTIONS: SelectOption[] = [
