...
export default withNuxt(
  ...
  [
    ...
    if (objIndex !== -1) {
      acc[objIndex] = deepmerge(acc[objIndex], val);
    } else {
      acc.push(val);
    }
    return acc;
  ...
  {
     name: '@ashimriat/airbnb-base/stylistic',
     plugins: {
  ...
  // {
  //   name: '@ashimriat/airbnb-base/import-x',
  //   plugins: {
