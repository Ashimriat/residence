import{s as x}from"./y7jn3q4Y.js";import{B as h,m as s,o as i,c as l,G as f,ac as m,ad as g,f as b,H as v,I as $,K as d,D as z,w as y,J as k}from"./aB8ygRKp.js";var w=function(a){var e=a.dt;return`
.p-textarea {
    font-family: inherit;
...
`)},B={root:function(a){var e=a.instance,r=a.props;return["p-textarea p-component",{"p-filled":e.$filled,"p-textarea-resizable ":r.autoResize,"p-textarea-sm p-inputfield-sm":r.size==="small","p-textarea-lg p-inputfield-lg":r.size==="large","p-invalid":e.$invalid,"p-variant-filled":e.$variant==="filled","p-textarea-fluid":e.$fluid}]}},V=h.extend({name:"textarea",theme:w,classes:B}),I={name:"BaseTextarea",extends:x,props:{autoResize:Boolean},style:V,provide:function(){return{$pcTextarea:this,$parentInstance:this}}},c={name:"Textarea",extends:I,inheritAttrs:!1,observer:null,mounted:function(){var a=this;this.autoResize&&(this.observer=new ResizeObserver(function(){a.resize()}),this.observer.observe(this.$el))},updated:function(){this.autoResize&&this.resize()},beforeUnmount:function(){this.observer&&this.observer.disconnect()},methods:{resize:function(){this.$el.offsetParent&&(this.$el.style.height="auto",this.$el.style.height=this.$el.scrollHeight+"px",parseFloat(this.$el.style.height)>=parseFloat(this.$el.style.maxHeight)?(this.$el.style.overflowY="scroll",this.$el.style.height=this.$el.style.maxHeight):this.$el.style.overflow="hidden")},onInput:function(a){this.autoResize&&this.resize(),this.writeValue(a.target.value,a)}},computed:{attrs:function(){return s(this.ptmi("root",{context:{filled:this.$filled,disabled:this.disabled}}),this.formField)}}},T=["value","disabled","aria-invalid"];function L(t,a,e,r,o,n){return i(),l("textarea",s({class:t.cx("root"),value:t.d_value,disabled:t.disabled,"aria-invalid":t.invalid||void 0,onInput:a[0]||(a[0]=function(){return n.onInput&&n.onInput.apply(n,arguments)})},n.attrs),null,16,T)}c.render=L;const R={key:0},C=f({__name:"BaseTextarea",props:m({placeholder:{default:""},maxLength:{default:0}},{modelValue:{required:!0},modelModifiers:{}}),emits:["update:modelValue"],setup(t){const a=g(t,"modelValue"),e=b(()=>t.maxLength===0?{}:{maxlength:t.maxLength}),r=v("BaseTextarea");return(o,n)=>{const u=c;return i(),l("div",{class:k(d(r)())},[$(u,s(d(e),{modelValue:a.value,"onUpdate:modelValue":n[0]||(n[0]=p=>a.value=p),fluid:"",placeholder:o.placeholder,maxlength:o.maxLength}),null,16,["modelValue","placeholder","maxlength"]),o.maxLength?(i(),l("span",R,z(`${a.value.length}/${o.maxLength}`),1)):y("",!0)],2)}}});export{C as _};
