import{_ as st}from"./CywyzhAB.js";import{d as ot,e as it}from"./BhBKweQS.js";import{_ as rt}from"./D5X2OJ2L.js";import{E,_ as lt}from"./DYEV0WKN.js";import{_ as ct,s as ut}from"./Cd0dcD9e.js";import{_ as dt}from"./BUY4Ir9x.js";import{s as bt}from"./JCoPW1O3.js";import{E as pt,a as H}from"./Bd5TAZbL.js";import{f as M,h as ft,r as U,e as J,i as Q,o as i,j as v,w as m,c as b,n as p,l as o,b as y,p as k,L as V,q as B,F as w,k as x,B as A,aj as j,I as g,m as f,M as _,Q as G,ad as z,ae as vt,J as K,aH as R,aI as q,z as F,aJ as ht,aK as I,an as mt,aL as gt,R as X,ah as Y,y as N,aD as yt,g as $t,u as Tt,K as Bt,aE as kt,ab as D}from"./DYZ8s7Mf.js";import{s as wt}from"./CIzO8uEd.js";import{u as Ct,_ as Pt}from"./fFEyZJ-J.js";const Lt=M({__name:"EventCard",props:{withDetails:{type:Boolean},isAccountMode:{type:Boolean},eventData:{}},emits:["signUp"],setup(e,{emit:t}){const n=t,{isMobile:s}=ft(),r=U(!1),{gameData:a,isAbonWorks:u,currentPlayers:d}=e.eventData,h=J(()=>r.value?E.CLOSE:E.DETAILS);function c(){r.value=!r.value}const l=Q("EventCard");return($,P)=>{const S=bt,O=rt,L=lt,T=ct,C=dt;return i(),v(C,{orientation:"column",class:p(o(l)({account:$.isAccountMode}))},{subContent:m(()=>[$.isAccountMode?B("",!0):(i(),b("div",{key:0,class:p(o(l)("topContainer"))},[y("div",{class:p(o(l)("masterDataBlock"))},[k(S,{label:"UI",shape:"circle"}),y("div",{class:p(o(l)("masterName"))},V(o(a).master),3)],2),y("div",{class:p(o(l)("playersAmount"))},[y("span",null,V(`${o(d).length}/${o(a).maxPlayersAmount}`),1),k(O,{type:o(pt).USERS,size:o(s)?o(H).S:o(H).M},null,8,["type","size"])],2)],2))]),content:m(()=>[k(T,{data:$.eventData,"is-account-mode":$.isAccountMode,"with-abon":o(u)&&!$.isAccountMode},{default:m(()=>[$.withDetails?(i(),b(w,{key:0},[o(r)?(i(),b("div",{key:0,class:p(o(l)("detailsBlock"))},[y("div",null,V(o(a).description),1),y("div",{class:p(o(l)("playersBlock"))},[(i(!0),b(w,null,x(o(d),W=>(i(),v(S,{key:W,label:"UI"}))),128))],2)],2)):B("",!0),y("div",{class:p(o(l)("buttonsBlock"))},[k(L,{type:o(E).ENTER_EVENT,onClick:P[0]||(P[0]=W=>n("signUp"))},null,8,["type"]),k(L,{type:o(h),"omit-icon":"",onClick:c},null,8,["type"]),o(r)?(i(),v(L,{key:0,type:o(E).SHARE},null,8,["type"])):B("",!0)],2)],64)):B("",!0)]),_:1},8,["data","is-account-mode","with-abon"])]),_:1},8,["class"])}}});var xt=function(t){var n=t.dt;return`
.p-tabs {
    display: flex;
