...
`)},A={root:"p-iconfield"},I=l.extend({name:"iconfield",theme:_,classes:A}),S={name:"BaseIconField",extends:m,style:I,provide:function(){return{$pcIconField:this,$parentInstance:this}}},z={name:"IconField",extends:S,inheritAttrs:!1};function K(t,e,n,i,r,a){return u(),d("div",y({class:t.cx("root")},t.ptmi("root")),[p(t.$slots,"default")],16)}z.render=K;var T={root:"p-inputicon"},P=l.extend({name:"inputicon",classes:T}),w={name:"BaseInputIcon",extends:m,style:P,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},M={name:"InputIcon",extends:w,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function O(t,e,n,i,r,a){return u(),d("span",y({class:a.containerClass},t.ptmi("root")),[p(t.$slots,"default")],16)}M.render=O;export{D as K,M as a,z as s};
