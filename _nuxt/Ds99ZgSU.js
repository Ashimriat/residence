import{_ as M}from"./7PrDBm7e.js";import{_ as K}from"./BFvq3nIf.js";import{I as k,f as N,K as $,o as t,c,d as r,a8 as x,M as o,D as m,L as s,B as w,m as a,v as f,w as u,s as z,b as B,x as g,z as C,y as V,C as Z,N as y,aC as j,aD as W}from"./C_juUXos.js";import{E as O}from"./Bd5TAZbL.js";const R={isAbonWorks:!0,oldPrice:400,price:300,gameData:{title:"Городская мафия",description:"Cоберитесь вместе для того, чтобы вычислить коварную мафию! Красные городские жители или же чёрная мафиозная команда - кто останется победителем, а кто покинет город?",master:"Александр",maxPlayersAmount:10,date:"10 марта",time:"18:00"},currentPlayers:["фывфыв","йцайцайц","фыайцайца","ывафафы","цукпцукп","ывапывап","авпвапва","пывапывуа"],locationData:{address:"Ул. Пушкина, д. Колотушкина 14 кв. 88",subway:{branchType:"standard5",station:"Октябрьская"},mapLink:"https://ololo.ru"}},_=e=>Array.from({length:e},()=>R),hn=(e,i)=>Array.from({length:e},()=>_(i)),q=k({__name:"SubwayStation",props:{branchType:{},station:{}},setup(e){const i=N(()=>({"--backgroundColor":"#805441"})),n=$();return(v,d)=>(t(),c("div",{class:s(o(n)())},[r("span",{style:x(o(i))},null,4),r("span",null,m(v.station),1)],2))}});var F=function(i){var n=i.dt;return`
