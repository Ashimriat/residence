import{B as l,au as v,av as c,o as d,c as u,I as p,m as y,M as m}from"./DYZ8s7Mf.js";var h=l.extend({name:"keyfilter-directive"}),g=v.extend({style:h});function b(t){return x(t)||E(t)||$(t)||k()}function k(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
`)},I={root:"p-iconfield"},A=l.extend({name:"iconfield",theme:_,classes:I}),S={name:"BaseIconField",extends:m,style:A,provide:function(){return{$pcIconField:this,$parentInstance:this}}},z={name:"IconField",extends:S,inheritAttrs:!1};function K(t,e,n,i,r,a){return d(),u("div",y({class:t.cx("root")},t.ptmi("root")),[p(t.$slots,"default")],16)}z.render=K;var T={root:"p-inputicon"},P=l.extend({name:"inputicon",classes:T}),M={name:"BaseInputIcon",extends:m,style:P,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},w={name:"InputIcon",extends:M,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function O(t,e,n,i,r,a){return d(),u("span",y({class:a.containerClass},t.ptmi("root")),[p(t.$slots,"default")],16)}w.render=O;export{B as K,z as a,w as s};
