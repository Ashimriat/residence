import{_ as M}from"./bEUHHbUm.js";import{_ as K}from"./B8lZA_QO.js";import{d as k,s as N,a as $,o as t,c,b as r,C as x,e as o,t as m,n as s,H as w,x as a,r as f,k as u,I as z,a0 as B,h as g,l as C,w as V,j as Z,f as y,ad as j,ae as W}from"./BP5lhVkG.js";import{E as H}from"./CmywsH7y.js";const O={isAbonWorks:!0,oldPrice:400,price:300,gameData:{title:"Городская мафия",description:"Cоберитесь вместе для того, чтобы вычислить коварную мафию! Красные городские жители или же чёрная мафиозная команда - кто останется победителем, а кто покинет город?",master:"Александр",maxPlayersAmount:10,date:"10 марта",time:"18:00"},currentPlayers:["фывфыв","йцайцайц","фыайцайца","ывафафы","цукпцукп","ывапывап","авпвапва","пывапывуа"],locationData:{address:"Ул. Пушкина, д. Колотушкина 14 кв. 88",subway:{branchType:"standard5",station:"Октябрьская"},mapLink:"https://ololo.ru"}},R=e=>Array.from({length:e},()=>O),hn=(e,i)=>Array.from({length:e},()=>R(i)),_=k({__name:"SubwayStation",props:{branchType:{},station:{}},setup(e){const i=N(()=>({"--backgroundColor":"#805441"})),n=$();return(v,d)=>(t(),c("div",{class:s(o(n)())},[r("span",{style:x(o(i))},null,4),r("span",null,m(v.station),1)],2))}});var q=function(i){var n=i.dt;return`
